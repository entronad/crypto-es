...
const blowfishCtx: BlowfishContext = {
  pbox: [],
  sbox: [],
};
...
function blowfishEncrypt(ctx: BlowfishContext, left: number, right: number): {left: number, right: number} {
  let Xl = left;
  let Xr = right;
  let temp;
...
function blowfishDecrypt(ctx: BlowfishContext, left: number, right: number): {left: number, right: number} {
  let Xl = left;
  let Xr = right;
  let temp;
